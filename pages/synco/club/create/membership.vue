<template>
  <NuxtLayout name="syncolayout" page-title="Booking Form">
    <div class="card bg-secondary rounded-4">
      ...
      >
        <NuxtLink class="h4 text-light m-0" to="/synco/club/find">
          <Icon name="material-symbols:arrow-back" class="me-2" />Book a Club
          Membership
        </NuxtLink>
      </div>
    </div>
    <div class="row">
      <div class="col-4">
        <div class="card rounded-4 mt-4 px-3">
          <h5 class="py-4"><strong>Club Membership plan</strong></h5>
          <div class="row">
            <div class="col-12">
              <div class="w-100 mb-3">
                <label for="teamInfo" class="form-labelform-label-light"
                  >Team</label
                >
