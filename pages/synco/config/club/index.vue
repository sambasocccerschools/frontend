...
export default {
  data: () => ({
    ...
    clubs: [
      {
        leagueName: 'Camden Youth League',
        ageGroup: 'Under 8s',
        training: 'King Solomon Academy',
        matches: 'Carams Field'
      }
    ]
  }),
  methods: {
    ...
    <div class="row">
      <div class="col">
        <div class="d-flex justify-content-between mb-4">
          <h4>Clubs</h4>
          <button class="btn btn-primary text-light" @click="panel = !panel">+ Add New Club</button>
        </div>
        ...
        <table class="table table-hover table-sm border rounded-4 shadow-sm">
          <thead class="rounded-top-4">
            <tr class="table-light ">
              ...
              <th class="text-muted" scope="col">Age Group</th>
              <th class="text-muted" scope="col">Training</th>
              <th class="text-muted" scope="col">Matches</th>
              <th scope="col"></th>
              <th scope="col"></th>
            </tr>
          </thead>
          <tbody class="">
            <tr class="align-middle" v-for="club in clubs">
              <th scope="row">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="league" placeholder="Chelsea">
            </div>
            <div class="mb-3">
              <label for="age-group" class="form-label">Age Group</label>
              <input type="text" class="form-control" id="age-group" placeholder="Chelsea Academy">
              <span class="text-danger">is this a dropdown or text input?</span>
            </div>
            <div class="mb-3">
              <label for="address" class="form-label">Training Address</label>
            ...
            <div class="mb-3">
              <label for="match-address" class="form-label">Match Address</label>
              <input type="text" class="form-control" id="match-address"
                placeholder="Carams Field, Ongur road, London, SW10 0AB">
              <span class="text-danger">What's this ?</span>
            </div>

            <div class="mb-3">
              <label for="subscription-plan" class="form-label">Subscription Plans</label>
              <select class="form-select" aria-label="Select plans" id="subscription-plan">
                <option selected disabled>Subscription Plans</option>
                <option value="1">Add New Price+</option>
                <option value="2">Camden youth League U'8</option>
                <option value="2">Camden youth League U'9</option>
                <option value="2">Camden youth League U'10</option>
                <option value="2">Camden youth League U'11</option>
                <option value="2">Camden youth League U'12</option>
              </select>
              <span class="text-danger">Fix the price management section</span>

            </div>

            <div class="d-flex gap-4">
              <button class="btn btn-outline-secondary btn-lg w-100" @click="panel = !panel">Cancel</button>
              <button class="btn btn-primary btn-lg w-100 text-light" @click="saveData()">Update</button>
            </div>
