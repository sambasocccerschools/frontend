...
<template>
  <NuxtLayout name="syncolayout" pageTitle="Email Marketing Campaigns">
    ...
    <div v-if="view === 'list'">
      <SyncoEmailMarketingListItem v-for="survey in surveys" view="list" />
    </div>
    <div v-if="view === 'card'" class="row row-cols-sm-4 g-4">
      <SyncoEmailMarketingListItem v-for="survey in surveys" view="card" />
    </div>
  </NuxtLayout>
</template>
