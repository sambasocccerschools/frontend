<template>
  <NuxtLayout name="syncolayout" page-title="Booking Form">
    <div class="card bg-secondary rounded-4">
      ...
      >
        <NuxtLink class="h4 text-light m-0" to="/synco/holiday-camps/find">
          <Icon name="material-symbols:arrow-back" class="me-2" />Book a Holiday
          Camp
        </NuxtLink>
      </div>
    </div>
      ...
      <div class="col-4">
        <div class="card rounded-4 mt-4 px-3">
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="form-group w-100 mb-3">
                <label for="students" class=""> Number of Students </label>
                <input
                  id="students"
                  type="number"
                  class="form-control form-control-lg"
            ...
            <div class="col-12">
              <div class="form-group w-100 mb-3">
                ...
                <select id="coach" class="form-control form-control-lg">
                  <option>Choose holiday camp(s)</option>
                </select>
              </div>
            </div>
            <div class="col-12">
