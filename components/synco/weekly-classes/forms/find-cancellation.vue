<template>
  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      ...
      <div class="form-group mb-3">
        ...
        <div class="container">
          <div class="row row-cols-2">
            ...
            >
              <option value="0">All</option>
              <option v-for="status in cancelStatus" :value="status.id">
                {{ status.title }}
              </option>
            </select>
          </div>
      ...
      <div class="form-group mb-3">
        <label for="lead_status" class="form-label">Choose type</label>
        <div class="container">
          <div class="row row-cols-2">
            <select
              id="lead_status"
            ...
            >
              <option value="0">All</option>
              <option v-for="status in cancelType" :value="status.id">
                {{ status.title }}
              </option>
            </select>
          </div>
...
const applyFilter = () => {
  emit('applyFilter', {
    ...
    member_cancel_status_id: status_id.value,
    member_cancel_type_id: status_id.value,
