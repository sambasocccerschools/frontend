...
const showOneToOne = ref<boolean>(true)
const showHolidayCamps = ref<boolean>(true)
const showBirthdayParties = ref<boolean>(true)
...
const showConfigurationHolidayCamps = ref<boolean>(true)
const showConfigurationBirthdayParties = ref<boolean>(true)
const showConfigurationClub = ref<boolean>(false)
const showConfigurationOneToOne = ref<boolean>(true)
