        ...
        <div class="container">
          <div class="row row-cols-2">
            <div class="form-check col">
              <input class="form-check-input" type="radio" name="filter-type" id="package">
              <label class="form-check-label" for="package">
                Package
              </label>
            </div>
            <div class="form-check col">
              <input class="form-check-input" type="radio" name="filter-type" id="date-of-party">
              <label class="form-check-label" for="date-of-party">
                Date of party
              </label>
            </div>
            <div class="form-check col">
              <input class="form-check-input" type="radio" name="filter-type" id="source">
              <label class="form-check-label" for="source">
                Source
              </label>
            </div>
            <div class="form-check col">
              <input class="form-check-input" type="radio" name="filter-type" id="agent-name">
              <label class="form-check-label" for="agent-name">
                Agent name
              </label>
            </div>
            <div class="form-check col">
              <input class="form-check-input" type="radio" name="filter-type" id="coach-name">
              <label class="form-check-label" for="coach-name">
                Coach name
              </label>
            </div>
          </div>
