      ...
      <div class="bg-light rounded-4 px-3 py-2 mb-5">
        ...
        <div class="container">
          <div class="row row-cols-2">
            ...
            <div class="form-check col">
              <input class="form-check-input" type="radio" name="filter-type" id="gold">
            ...
            <div class="form-check col">
              <input class="form-check-input" type="radio" name="filter-type" id="silver">
            ...
            <div class="form-check col">
              <input class="form-check-input" type="radio" name="filter-type" id="party-date">
              <label class="form-check-label" for="party-date">
                Date of party
              </label>
            </div>
