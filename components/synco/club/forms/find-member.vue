  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      ...
      <div class="form-group">
        <label for="choose-team" class="form-label">Team</label>
        <select class="form-select" aria-label="choose-team">
      ...
      <div class="bg-light rounded-4 px-3 py-2 mb-5">
        ...
        <div class="container">
          <div class="row row-cols-2">
            ...
            <div class="form-check col">
              <input class="form-check-input" type="radio" name="filter-type" id="life-cycle">
              <label class="form-check-label" for="life-cycle">
                Life Cycle
              </label>
            </div>
          </div>
